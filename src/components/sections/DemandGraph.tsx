...
//   - public/images/demand-trend.png  (the chart Pascal exported 2026-05-07)
//   - docs/data/google-trends-bfr-worldwide.csv  (full monthly time series)
//
// Constants below are validated against the CSV. To refresh: replace both files
// with fresh exports from trends.google.com/trends/explore?q=blood+flow+restriction&date=all
// and update the four constants if the inflection or peak shift.
        ...
        >
          <motion.div variants={fadeUp} className="lg:col-span-5">
            ...
            <h2 className="mt-5 font-display text-display-xl text-navy text-balance">
              Search interest just {SURGE_MULTIPLE}×&apos;d in {SURGE_DURATION_MONTHS} months. {PEAK_MONTH} was the all-time peak.
            </h2>
            <p className="mt-6 text-lg leading-relaxed text-ink/85">
              From {PRE_SURGE_MONTH} to {PEAK_MONTH}, Google searches for &ldquo;blood flow restriction&rdquo; climbed from {PRE_SURGE_VALUE} to {PEAK_VALUE} on the normalized index. The single biggest jump happened in one month: July&apos;s {PRE_SURGE_VALUE} became August&apos;s {AUGUST_SURGE_VALUE}.
            </p>
            <p className="mt-4 text-base leading-relaxed text-ink/85">
              The previous all-time high was {PRIOR_ALL_TIME_HIGH_VALUE}, set in {PRIOR_ALL_TIME_HIGH_MONTH}. {PEAK_MONTH} cleared it by {PEAK_VS_PRIOR}×.
            </p>
          ...
          <motion.figure variants={fadeUp} className="lg:col-span-7">
            <div className="rounded-2xl border border-line bg-white p-3 sm:p-5 shadow-[0_30px_60px_-30px_rgba(25,55,99,0.18)]">
              <Image
                src="/images/demand-trend.png"
                alt={`Google Trends chart showing worldwide search interest for "blood flow restriction" from January 2012 to May 2026. The line climbs slowly until August 2025 then spikes to a peak of ${PEAK_VALUE} in ${PEAK_MONTH}.`}
                width={920}
                height={340}
            ...
            <figcaption className="mt-3 text-xs text-muted">
              Source: Google Trends, search term &ldquo;blood flow restriction,&rdquo; Worldwide, January 2012 to May 2026. Index normalized 0-100 where 100 represents peak interest. Full monthly time series archived at <code className="font-mono">docs/data/google-trends-bfr-worldwide.csv</code>.
            </figcaption>
          </motion.figure>
        </motion.div>
      </div>
